	...
	<div class="container-fluid">
		...
		-->
				<form method="post" action="patientRegister">
					SSN:<input type="text" class="m-1 form-control" pattern="[0-9]{9}" placeholder="123456789" id="patientSSN" name="patientSSN" required>
					...
					Address:<input class="m-1 form-control" type="text" id="address"> 
